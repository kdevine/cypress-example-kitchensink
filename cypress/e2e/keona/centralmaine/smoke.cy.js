...
describe('Central Maine Tests', () => {
  ...
  it(locations[0].client + ' ' + locations[0].area + ' triage test', () => {
    ...
    cy.get('#MainContent_liLogin_txtUserName').type(this.data.nurse-login);
    cy.get('#MainContent_liLogin_txtPassword').type(this.data.nurse-password);
    ...
    cy.get('#survey_answer_1092857').type('Automated Testing');
